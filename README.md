# Steven Galloway
Senior Technology Executive & Engineer | Data, Software, ML & Cloud Architecture
...
|--------------------------|-----------|-----------|
| Solutions Architecture & System Design | Requirements translation, system design, architectural tradeoffs, and scalability and reliability planning | [architecture-patterns](https://github.com/StevenGalloway/architecture-patterns)<br></br> [netflix-architecture-case-study](https://github.com/StevenGalloway/netflix-architecture-case-study) <br></br> [Full Stack Production Engineering](https://github.com/StevenGalloway/full-stack-production-engineering) |
...
**[CNN - Handwriting Recognition Application](https://github.com/StevenGalloway/machine-learning-projects/tree/main/case-studies/convolutional-models/handwriting-recognition)** (Application for text input, with ML models to determine input written text)\
**[Monte Carlo - Superbowl Prediction 2026](https://github.com/StevenGalloway/machine-learning-projects/tree/main/case-studies/monte-carlo-models/superbowl-2026-prediction)** (Predicting outcome based on critical features)\
**[Naives Bayes - Text Sender Identification](https://github.com/StevenGalloway/machine-learning-projects/tree/main/case-studies/naives-bayes-models/text-sender-identification)** (Predicting incoming messaging source using context)\
**[Markov Model (Jupyter) - Weather Prediction](https://github.com/StevenGalloway/machine-learning-projects/tree/main/notebooks/jupyter/weather-prediction)** (Weather prediction based on trend data and likelihood)\
...
\
Additional Python is embedded throughout other repositories including **[machine-learning-lab](https://github.com/StevenGalloway/machine-learning-lab)** and **[object-oriented-systems](https://github.com/StevenGalloway/object-oriented-systems)**.
